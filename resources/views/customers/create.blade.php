...
<div style="max-width: 500px; margin: 0 auto; background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.03);">
    ...
    <form action="{{ route('customers.store') }}" method="POST">
        ...
        <label style="display: block; font-size: 13px; font-weight: bold; color: #4a5568; margin-bottom: 5px;">Full Name</label>
        <input type="text" name="name" required placeholder="Lastname, Firstname"
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 10px;">
            ...
            <a href="{{ route('customers.index') }}" style="text-decoration: none; font-size: 13px; color: #718096; font-weight: 500;">
                Back to List
            </a>
        </div>
    </form>
